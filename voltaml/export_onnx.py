...
import sys
sys.path.insert(0, './voltaml/yolov6')


from voltaml.yolov6.models.yolo import *
from voltaml.yolov6.models.effidehead import Detect
...
if __name__ == '__main__':
    ...
    if args.end2end:
        from voltaml.yolov6.models.end2end import End2End
