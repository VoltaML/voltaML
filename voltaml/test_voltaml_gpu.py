...
def get_args():
    ...
    parser.add_argument("--torch_model_dir", default="/workspace/voltaML/voltaml/yolov5s.pt", type=str)
    parser.add_argument("--compiled_model_dir", default="/workspace/voltaML/voltaml/yolov5s.engine", type=str)
